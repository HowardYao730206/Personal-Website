...
const WORKS: Work[] = [
  ...
  { cat: 'music',       title: 'Song Title — Cover',         desc: 'Your Vocaloid arrangement and what drew you to this song.',          year: '2024', color: '#3a7bd5' },
  { cat: 'music',       title: 'Original Track Name',        desc: 'The feeling or story you wanted to capture.',                        year: '2023', color: '#3a7bd5' },
...
const FILTERS = ['all', 'research', 'music', 'photography'] as const;
  ...
  return (
    <section className="max-w-3xl mx-auto px-8 py-24">
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
        ...
        <h2 className="font-maru font-black text-4xl text-ink mb-8 tracking-tight">Selected works</h2>
