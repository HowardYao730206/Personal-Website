...
const WORKS: Work[] = [
  { cat: 'research', slug: 'works/fmcw-radar',     title: 'A 60 GHz Millimeter-Wave FMCW Radar System for Real-Time Observations in Remote Outdoor Environments', desc: 'IEEE SAS 2025 — Best Poster Award. Weatherproof mmWave radar for long-term environmental field deployments.', year: '2025', color: '#e84040' },
  { cat: 'research', slug: 'works/kriging-spatial', title: 'Portable Cellular Signal Towers for 5G-based Data Collection and Kriging-based Spatial Interpolation in Fields', desc: 'DOE CCI Program. Raspberry Pi + 5G sensor platform with Ordinary Kriging for real-time geospatial RSSI mapping.', year: '2024', color: '#e84040' },
];
